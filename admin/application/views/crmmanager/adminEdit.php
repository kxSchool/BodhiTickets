				...
				<div class="box">
					...
					<div class="box-body">
						<form id="adminForm" class="form-horizontal" method="post" action="<?php echo site_url('crmmanager/saveAdmin');?>">
								...
								<div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="shopid" id="shopid" readonly="true" placeholder="商户id号" value="<?php echo $shopid;?>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" name="userid" value="<?php echo $userid;?>" />
                                                                        ...
                                                                        <input type="text" class="form-control" name="account" id="account" readonly="true" placeholder="输入登陆账号" value="<?php echo $username;?>" />
								</div>
							</div>
							<div class="form-group">

...
<script>
	$(function(){
		...
		$("#mini").fileinput({
			...
			<?php if(isset($mapInfo['mini_url']) && !empty($mapInfo['mini_url'])):?>
			initialPreview: [
				'<img src="<?php echo $mapInfo['mini_url'];?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#background").fileinput({
			...
			<?php if(isset($mapInfo['background_url']) && !empty($mapInfo['background_url'])):?>
			initialPreview: [
				'<img src="<?php echo $mapInfo['background_url'];?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,

...
<script src="<?php echo STATIC_PATH;?>cropper/js/cropper.min.js"></script>
<script src="<?php echo STATIC_PATH;?>cropper/js/main.js"></script>
<script>
	$(function(){
		$('input').iCheck({
												...
												<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<form class="avatar-form" action="<?php echo site_url('upload/avatar');?>?whoAvatar=admin" enctype="multipart/form-data" method="post">
									...
									<form id="adminForm" class="form-horizontal" method="post" action="<?php echo site_url('index/saveProfile');?>">
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<input type="text" class="form-control" id="account" name="account" placeholder="输入登陆账号" value="<?php echo $adminInfo['account'];?>">
											</div>
										</div>
										<div class="form-group">
											<label for="rolename" class="col-sm-2 control-label">角色</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" id="rolename" name="rolename" placeholder="输入登陆账号" value="<?php echo $adminInfo['rolename'];?>" disabled="disabled">
											</div>
										</div>
										<div class="form-group">

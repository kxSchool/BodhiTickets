		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form id="cateForm" class="form-horizontal" method="post" action="<?php echo site_url('panorama/panorama_save');?>?section_id=<?php echo $sectionInfo['id'];?>">
                            ...
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="mini_name" type="hidden" name="mini_name" value="<?php echo $mini;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="front_name" type="hidden" name="front_name" value="<?php echo $front;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="back_name" type="hidden" name="back_name" value="<?php echo $back;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="left_name" type="hidden" name="left_name" value="<?php echo $left;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="right_name" type="hidden" name="right_name" value="<?php echo $right;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="top_name" type="hidden" name="top_name" value="<?php echo $top;?>" />
								</div>
							</div>
                            <div class="form-group" id="ad_image_code" style="display:block;">
								...
								<div class="col-sm-10">
									...
									<input id="bottom_name" type="hidden" name="bottom_name" value="<?php echo $bottom;?>" />
								</div>
							</div>
...
<script>
	$(function(){
		...
		$("#mini").fileinput({
			...
			<?php if(isset($mini) && !empty($mini)):?>
			initialPreview: [
				'<img src="<?php echo $mini_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#front").fileinput({
			language: "zh",
			uploadUrl:"<?php echo site_url('upload/doUpload');?>?type=panorama&section_id=<?php echo  $sectionInfo['id'];?>" ,//上传文件路径
			<?php if(isset($front) && !empty($front)):?>
			initialPreview: [
				'<img src="<?php echo $front_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#back").fileinput({
			...
			initialPreview: [
				'<img src="<?php echo $back_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#left").fileinput({
			...
			initialPreview: [
				'<img src="<?php echo $left_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#right").fileinput({
			...
			initialPreview: [
				'<img src="<?php echo $right_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#top").fileinput({
			...
			initialPreview: [
				'<img src="<?php echo $top_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,
		...
		$("#bottom").fileinput({
			...
			initialPreview: [
				'<img src="<?php echo $bottom_imgurl;?>" class="file-preview-image">'
			],
			<?php endif;?>
			autoReplace: true,
			maxFileCount: 1,

						...
						<div class="tables">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>
										<a class="btn btn-sm btn-info" href="<?php echo site_url('manager/editAdmin');?>?id=<?php echo $v['id'];?>">编辑</a>
										<a class="btn btn-sm btn-danger" href="javascript:delAdmin(<?php echo $v['id'];?>);">删除</a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>

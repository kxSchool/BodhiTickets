					...
					<div class="box-body">
						<form id="starForm" class="form-horizontal" method="post" action="<?php echo site_url('members/saveStar');?>">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="starname" id="starname" placeholder="输入星级名" value="" />
								</div>
							</div>
							<div class="form-group">
								<label for="low" class="col-sm-2 control-label">低经验值：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="low" id="low" placeholder="输入低经验值" value="" />
								</div>
							</div>
							<div class="form-group">
								<label for="high" class="col-sm-2 control-label">高经验值：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="high" id="high" placeholder="输入高经验值" value="" />
								</div>
							</div>
							<div class="form-group">
								<label for="price" class="col-sm-2 control-label">对应价格：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="price" id="price" placeholder="输入对应价格" value="" />
								</div>
							</div>

				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header with-border">
							<div class="pull-left">
								<a type="button" class="btn btn-success" href="<?php echo site_url('members/addStores');?>?type=<?php echo $type;?>"><span class="glyphicon glyphicon-plus"></span>添加商铺</a>
							</div>

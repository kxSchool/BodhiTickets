		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form id="cateForm" class="form-horizontal" method="post" action="<?php echo site_url('price/price_save');?>">
                            <input type="hidden" class="form-control" name="section_id" id="section_id" value="<?php echo $section_id;?>" />
                            <div class="form-group">
								<label for="price_name" class="col-sm-2 control-label">区域名称：</label>
								<div class="col-sm-10">
                                    <input type="text" class="form-control" name="price_name" id="price_name" value="<?php echo $section['section_name'];?>" />
                                </div>
                            </div>
                            <div class="form-group">

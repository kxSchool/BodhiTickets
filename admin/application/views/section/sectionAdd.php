...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('map/manage');?>?show_id=<?php echo $mapInfo['map_id'];?>">座位图管理</a></li>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form id="cateForm" class="form-horizontal" method="post" action="<?php echo site_url('section/section_save');?>">
                                <input type="hidden" class="form-control" name="map_id" id="map_id" value="<?php echo $map_id;?>" />

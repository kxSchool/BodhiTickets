...
class Verify {
    ...
    function __construct() {
        $rand = rand(0,1);
        if($rand==0) {
            $this->font = APPPATH .'libraries/Verify'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'elephant.ttf';
        } else {
            $this->font = APPPATH .'libraries/Verify'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'Vineta.ttf';
        }
    }

		...
		<section class="content">
			    <div class="admin_list w-m"  >
                                <div  style="margin-top:30px;">
                                    ...
                                    <div class="list-group col-md-12 clearfix o-p-r">
                                        <div class="list-group-item o-height add-inquiry">
                                            <h4 class="list-group-item-heading"><strong>物流设置</strong></h4>
                                            <table class="table table-hover table-bordered shipping-fee-tab" style="table-layout:fixed; max-width:600px; ">
                                                ...
                                                <tr>
                                                    <td><?php echo !empty($inquiryshippingfee[1])? $inquiryshippingfee[1] : '-' ;?></td>
                                                    <td><?php echo !empty($inquiryshippingfee[2])? $inquiryshippingfee[2] : '-' ;?></td>
                                                    <td><?php echo !empty($inquiryshippingfee[3])? $inquiryshippingfee[3] : '-' ;?></td>
                                                    <td><?php echo !empty($inquiryshippingfee[4])? $inquiryshippingfee[4] : '-' ;?></td>
                                                    <td><?php echo !empty($inquiryshippingfee[5])? $inquiryshippingfee[5] : '-' ;?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>

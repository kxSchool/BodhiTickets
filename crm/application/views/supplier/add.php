...
<head>
<meta charset="UTF-8">
<title>票商中心管理系统 | <?php echo empty($type)? '添加':'编辑';?>供货商</title>
					...
					<div class="box-body">
						<form id="membersForm" class="form-horizontal" method="post">
							...
							<div class= "form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="sellerid" id="sellerid" placeholder="输入所属卖家id" value="<?php echo empty($data['sellerid']) ? '' : $data['sellerid'];?>" />
								</div>
							</div>
                                                        <div class= "form-group">
								<label for="brandname" class="col-sm-2 control-label">供货商管理品牌：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="brandname" id="brandname" placeholder="多个品牌逗号分隔,如:宝马,一汽大众,上海大众" value="<?php echo empty($data['brand']) ? '' : $data['brand'];?>" />
								</div>
							</div>
<!--                                                        <div class= "form-group">
								<label for="sellerid" class="col-sm-2 control-label">所属卖家：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="sellerid" id="sellerid" placeholder="输入所属卖家id" value="" />
								</div>
							</div>  -->
							<div class="form-group">
